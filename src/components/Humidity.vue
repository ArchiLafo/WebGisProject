        ...
        <div class="block-bottom-texts">
          <div class="block-bottom-text-block">
            ...
            <div class="block-bottom-text-block-desc">
              ...
              Водяной пар, газообразное состояние воды, как правило, невидим для
              человеческого глаза.
              <br /><br />
              Такое же количество водяного пара приводит к более высокой относительной влажности
              в прохладном воздухе, а не в теплом.
            </div>
          </div>
        </div>
      </div>
